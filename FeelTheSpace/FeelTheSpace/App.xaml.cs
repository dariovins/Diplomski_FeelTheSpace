    ...
    sealed partial class App : Application
    {
        ...
        protected async override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            var storageFile = await Windows.Storage.StorageFile.GetFileFromApplicationUriAsync(
              new Uri("ms-appx:///FeelTheSpaceVoice.xml"));
        ...
        protected override void OnActivated(IActivatedEventArgs args)
        {
            ...
            {
                case "feel":
                    // Access the value of the{action} phrase in the voice command
                    string action = speechRecognitionResult.SemanticInterpretation.Properties["action"][0];
                    string option = speechRecognitionResult.SemanticInterpretation.Properties["option"][0];
